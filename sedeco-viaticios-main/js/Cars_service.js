    ...
    <div class="card h-100 ${cardClass}" data-id="${car.id}">
        <div class="card-body">
            <div class="d-flex align-items-start mb-3">
                <i id="carIcon" class="fas fa-car fa-2x me-3 mt-1"></i>
                <div>
            ...
            <button class="btn btn-sm w-100 mb-2" onclick="selectCar('${car.id}', event)">
                ${isSelected ? '<i class="fas fa-check-circle me-1"></i>' : '<i class="fas fa-check me-1"></i>'}
            </button>
        </div>
    </div>
`;
